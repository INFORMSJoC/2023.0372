...
BASE_DIR = os.path.join('..', 'intermediate', 'movie', 'evaluation', 'rating')
...
class ModelEvaluator:
    def __init__(self):
        self.character_vector = torch.load(os.path.join('..', 'intermediate', 'movie', 'character_vector.pt'))
    ...
    def _run_pmf_single(self, verbose=False):
        ...
        train_loader = DataLoader(train_behavior, batch_size=10240, shuffle=False)
        test_loader = DataLoader(test_behavior, batch_size=10240, shuffle=False)
