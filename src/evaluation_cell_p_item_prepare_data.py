...
class GenerateItemInput:
    def __init__(self):
        self.base_dir = os.path.join('..', 'intermediate', 'cell_p', 'evaluation', 'item')
        ...
        self.train_num = 11780   # fixed split
    ...
    def _build_vocab_and_indices(self, data_dict, min_freq=3):
        """data_dict: {item_id: list_of_tokens}"""
    ...
    def generate_all(self):
        ...
        vocab_pos, pos_idx_lists, pos_num = self._build_vocab_and_indices(pos_dict, min_freq=3)
