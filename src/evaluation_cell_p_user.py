...
BASE_DIR = os.path.join('..', 'intermediate', 'cell_p', 'evaluation', 'user')
...
class UserEvaluator:
    ...
    def _run_our_model_single_with_net(self, verbose=False):
        ...
        for epoch in range(200):
            ...
            for batch in train_loader:
                ...
                loss = 0.01 * net.kl_loss(mean, log_var) + net.log_likelihood_loss(batch, wd)
                optimizer.zero_grad()
                loss.backward()
    ...
    def _run_dmm_single(self, our_net, verbose=False):
        ...
        optimizer = torch.optim.Adam(dmm_net.parameters(), lr=0.003)
